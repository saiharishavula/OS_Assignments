#!/bin/sh
# test hash of the files, hash of files with different content should be different.
...
content="This is a test file to test different hash functionality"
...
if test "$hash1" != "$hash2"; then
    echo "Test Passed. Hash of the files with different content are different."
else
    echo "Test Failed. Hash of the files with same content are same."
fi